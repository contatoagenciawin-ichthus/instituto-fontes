  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10 xl:px-14">
        <div className="fontes-shimmer relative min-h-[520px] overflow-hidden bg-[var(--fontes-navy)] sm:min-h-[600px] lg:min-h-[680px]">
          <video
            ...
            aria-hidden="true"
          >
            <source src="/media/instituto_fontes_secao_intermediaria_01.mp4" type="video/mp4" />
          </video>
          ...
          <video
            ...
            aria-hidden="true"
          >
            <source src="/media/instituto_fontes_secao_mobile_01.mp4" type="video/mp4" />
          </video>

          <div className="absolute inset-0 bg-[var(--fontes-blue)]/42 mix-blend-color" aria-hidden="true" />
          <div className="absolute inset-0 bg-[var(--fontes-navy)]/27 mix-blend-multiply" aria-hidden="true" />
          <div className="absolute inset-0 bg-gradient-to-t from-[var(--fontes-navy)]/86 via-[var(--fontes-navy)]/6 to-[var(--fontes-navy)]/14" aria-hidden="true" />

          <div className="fontes-breathe absolute -right-24 -top-24 z-10 h-72 w-72 rounded-full border-[28px] border-[var(--fontes-yellow)]/70 sm:h-96 sm:w-96" aria-hidden="true" />
          <img
            src="/brand/pattern-medio.png"
            alt=""
            className="fontes-wave-drift-slow absolute -right-[8%] top-[38%] z-10 w-[68%] brightness-[4] saturate-0 opacity-70"
            aria-hidden="true"
          />

          <div className="relative z-20 flex min-h-[520px] h-full flex-col justify-between px-7 py-8 sm:min-h-[600px] sm:px-10 sm:py-10 lg:min-h-[680px] lg:px-14 lg:py-12 xl:px-16">

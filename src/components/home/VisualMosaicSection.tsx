  ...
  return (
    <section className="relative overflow-hidden bg-[var(--fontes-off-white)]">
      <div className="mx-auto max-w-[1440px] px-6 pb-24 sm:pb-28 lg:px-10 lg:pb-32 xl:px-14 xl:pb-36">
        ...
        <div className="relative border border-[var(--fontes-navy)]/10 bg-white p-2 sm:p-3 lg:p-4">
          <img
            src="/brand/pattern-medio.png"
            alt=""
            className="fontes-wave-drift-slow pointer-events-none absolute left-[30%] top-[31%] z-30 hidden w-[58%] opacity-80 lg:block"
            aria-hidden="true"
          />
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-12 lg:grid-rows-[245px_245px_245px]">
            ...
            <div className="relative min-h-[260px] overflow-hidden bg-[var(--fontes-blue)] lg:col-span-3 lg:min-h-0">
            ...
            <div className="relative min-h-[260px] overflow-hidden bg-[var(--fontes-yellow)] lg:col-span-3 lg:min-h-0">
              ...
              <div className="fontes-breathe absolute -right-10 -top-10 h-32 w-32 rounded-full border-[14px] border-[var(--fontes-yellow)]" aria-hidden="true" />
              <div className="absolute bottom-6 left-6 right-6 sm:bottom-7 sm:left-7 sm:right-7">
            ...
            <div className="relative min-h-[260px] overflow-hidden bg-white lg:col-span-3 lg:min-h-0">
              ...
              <div className="absolute left-5 top-5 border-l-2 border-[var(--fontes-blue)] bg-white/92 px-4 py-2 text-[9px] font-semibold uppercase tracking-[0.23em] text-[var(--fontes-blue)] backdrop-blur-sm sm:text-[10px]">
                Formação profissional
              </div>
            </div>

            <div className="relative min-h-[260px] overflow-hidden bg-[var(--fontes-yellow)] p-7 sm:p-8 lg:col-span-3 lg:min-h-0">
              <div className="fontes-breathe absolute -right-12 -top-12 h-36 w-36 rounded-full border-[14px] border-white/24" aria-hidden="true" />
            ...
            <div className="relative min-h-[280px] overflow-hidden bg-[var(--fontes-navy)] lg:col-span-4 lg:min-h-0">
            ...
            <div className="relative min-h-[280px] overflow-hidden bg-white lg:col-span-5 lg:min-h-0">
            ...
            <div className="relative min-h-[280px] overflow-hidden bg-white p-7 sm:p-8 lg:col-span-3 lg:min-h-0">
              <div className="fontes-breathe absolute -right-12 top-5 h-36 w-36 rounded-full bg-[#D9EEFF]" aria-hidden="true" />
              <svg viewBox="0 0 300 110" className="fontes-wave-drift absolute left-6 top-7 w-[78%]" fill="none" aria-hidden="true">
                <path className="fontes-line-flow" d="M0 55C58 8 93 88 155 45C211 6 242 70 300 28" stroke="var(--fontes-blue)" strokeWidth="6" strokeLinecap="round" />
